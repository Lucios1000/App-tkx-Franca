...
import { LayoutDashboard, TrendingUp, Map as MapIcon, Sliders, FileText, Users, PieChart, Briefcase, BarChart3, Target, UserCheck, Download, Printer, Megaphone, Zap, Save, Trash2, Rocket, ClipboardList, Activity, MessageCircle } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, setActiveTab, onExportPDF, onExportExcel, onOpenSnapshots, onClearParams }) => {
  const tabs = [
    ...
    { id: 19, label: 'ASSISTENTE IA', icon: <MessageCircle size={22} /> },
    { id: 20, label: 'TESTES', icon: <Activity size={22} /> },
  ];
